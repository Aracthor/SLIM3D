...
Cube::onInit()
{
    ...
    slim::shader::Shader*	vertexShader = slim::assets::Asset::create<slim::shader::Shader>(chunk, "textured.vert", slim::shader::Shader::VERTEX);
    slim::shader::Shader*	fragmentShader = slim::assets::Asset::create<slim::shader::Shader>(chunk, "textured.frag", slim::shader::Shader::FRAGMENT);
    slim::shader::Program*	program = slim::assets::Asset::create<slim::shader::Program>(chunk, "textured", vertexShader, fragmentShader);
    slim::mesh::Material*	basicMaterial = slim::assets::Asset::create<slim::mesh::Material>(chunk, program, "textured");
    slim::camera::Camera*	camera = chunk.create<slim::camera::FreeFly>();

    slim::texture::Texture*	texture = slim::assets::Asset::create<slim::texture::Texture>(chunk, chunk, "dirt.png");

    this->setClearColor(slim::mesh::Color(1.0, 1.0, 1.0, 1.0));
    ...
    basicMaterial->setTexture(texture);
...
void
Cube::onUpdate(slim::time::Clock::time elapsed)
{
    (void)elapsed;
}
